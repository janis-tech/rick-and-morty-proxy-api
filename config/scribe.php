...
return [
    ...
    'title' => 'Rick and Morty Proxy API Documentation',
    ...
    'postman' => [
        ...
        'overrides' => [
            'info.version' => '1.0.0',
            'info.name' => 'Rick and Morty Proxy API',
        ],
    ],
    ...
    'openapi' => [
        ...
        'overrides' => [
            'info.version' => '1.0.0',
            'info.title' => 'Rick and Morty Proxy API',
        ],
    ...
    // Note: does not work for `external` docs types
    'last_updated' => 'Last updated: {date:F j, Y, H:i}',
